                                    ...
                                    <div class="wizard card">
                                        ...
                                        <div class="card-body p-6">
                                            ...
                                            <div
                                                ...
                                                @for ($i = 1; $i <= count($questions) + 3; $i++)
                                                    <div
                                                        class="{{ $i == session('tab') ? 'active pass' : '' }} relative z-[1] items-center item flex flex-start flex-1 last:flex-none group wizard-step {{ $i < session('tab') ? 'passed' : '' }}">
                                                    ...
                                                    <form id="form_departamento"
                                                        ...
                                                        <div class="form">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="input-area">
                                                                    ...
                                                                    <input id="departamento_abbrev" type="hidden"
                                                                        value="{{ $departamento ? $departamento->abbrev : '' }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <button
                                                                ...
                                                                type="button"
                                                                onclick="validar_departamento()">Siguiente</button>
                                                        </div>
                                                    </form>
                                                    <script>
