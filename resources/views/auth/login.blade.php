        ...
        <div class="lg:w-1/2 w-full flex flex-col items-center justify-center">
            <div class="auth-box-3">
                ...
                <form class="space-y-4" method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="row mb-3">
                        <label for="email" class="col-md-4 col-form-label text-md-end">Tipo de Inicio de Sesión</label>
                        <br>
                        <div class="col-md-6">
                            <br>
                            <table border="1" width="80%" style="margin-left: 10%;">
                                <tr>
                                    <td align="center" onclick="tipo_sesion(1)" style="color:#0F172A;" id="label-email"><iconify-icon icon="mdi:email-minus-outline" width="50" id="icon-email"></iconify-icon><br><small>Correo Electronico</small></td>
                                    <td>&nbsp;</td>
                    ...
                    <div class="fromGroup" id="telefono" style="display: none;">
                        <label class="block capitalize form-label"><iconify-icon icon="akar-icons:phone"></iconify-icon> Teléfono</label>
                        <div class="relative ">
