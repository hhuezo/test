                ...
                <div class="auth-box-3">
                    ...
                    <form class="space-y-4" method="POST" action="{{ route('login') }}">
                                ...
                                <table border="1" width="80%" style="margin-left: 10%;">
                                    <tr>
                                        <td align="center" onclick="tipo_sesion(1)" style="color:#0F172A;" id="label-email">
                                            <iconify-icon icon="mdi:email-minus-outline" width="50"
                                                id="icon-email"></iconify-icon><br><small>Correo Electronico</small>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td align="center" onclick="tipo_sesion(2)" style="color: lightgray;"
                                            id="label-telefono"><iconify-icon icon="akar-icons:phone" width="50"
                                                id="icon-telefono"></iconify-icon><br><small>Numero Telefono</small></td>
                                        <td>&nbsp;</td>
                                        <td align="center" onclick="tipo_sesion(3)" style="color: lightgray;"
                                            id="label-documento"><iconify-icon icon="solar:user-id-broken" width="50"
                                                id="icon-documento"></iconify-icon><br><small>Numero Documento</small></td>
                                    </tr>
                        ...
                        <div class="fromGroup" id="correo" style="display: block;">
                            <label class="block capitalize form-label"><iconify-icon
                                    icon="mdi:email-minus-outline"></iconify-icon> Correo electrónico</label>
                            <div class="relative ">
                        ...
                        <div class="fromGroup" id="telefono" style="display: none;">
                            <label class="block capitalize form-label"><iconify-icon icon="akar-icons:phone"></iconify-icon>
                                Teléfono</label>
                            <div class="relative ">
                                <input type="text" name="phone" id="phone" class="form-control py-2 " autocomplete
                        ...
                        <div class="fromGroup" id="documento" style="display: none;">
                            <label class="block capitalize form-label"> <iconify-icon
                                    icon="solar:user-id-broken"></iconify-icon> Número de DUI</label>
                            <div class="relative ">
                                <input type="text" name="document_number" id="document_number" class="form-control py-2"
                                    autocomplete data-inputmask="'mask': ['99999999-9']">
                        ...
                        <button class="btn btn-dark block w-full text-center" id="btn-inicio"
                            style="display: block;">Iniciar sesión</button>
                    </form>
                    <!-- END: Login Form -->
