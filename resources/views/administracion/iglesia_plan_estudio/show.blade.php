    ...
    <div>
        ...
        <div class=" md:flex justify-between items-center">
            ...
            <div class="flex flex-wrap ">
                <a href="{{url('administracion/iglesia_plan_estudio')}}" class="btn inline-flex justify-center btn-dark dark:bg-slate-700 dark:text-slate-300 m-1">
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="lg:col-span-8 col-span-12">
                                                ...
                                                <div class="card-body">
                                                    <div class="card-text h-full">
                                                        <header class="border-b px-4 pt-4 pb-3 flex items-center border-info-500">
                                                            ...
                                                            <button class="ml-auto btn-outline-dark btn btn-sm" id="btn_delete" data-bs-toggle="modal" data-bs-target="#modal-delete-{{$sesion->id}}">
                                                                <iconify-icon icon="ic:baseline-delete" style="color: black;" width="20"></iconify-icon>
                                                            </button>

                                                            <button class="ml-auto btn-dark btn btn-sm" id="btn_siguiente-{{$sesion->id}}" onclick="btn_next({{$sesion->id}});" style="margin-left: 2%;">
                                    ...
                                    <div class="grid xl:grid-cols-1 md:grid-cols-1 grid-cols-1 gap-5">
                                            ...
                                            <div class="card-body" id="asistencia-{{$sesion->id}}" style="display: none">
                                                <div class="card-text h-full">
                                                    ...
                                                    <div class="py-3 px-5" align="right">
                                                        <a href="" class="btn ml-auto btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#modal-archivo" onclick="modal_archivo({{$sesion->id}})"> <iconify-icon icon="majesticons:document" width="13"></iconify-icon> Documento de Sesion</a>

                                                        <a href="" class="btn ml-auto btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#modal-importar" onclick="modal_importar({{$sesion->id}})" style="vertical-align: middle; pointer-events: ;"> <iconify-icon icon="ri:file-excel-2-fill" width="13"></iconify-icon> Importar Archivo</a>
                                                    </div>
                                        ...
                                        <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$sesion->id}}">

                                            <form method="POST" action="{{ url('admin/delete_sesion') }}" enctype="multipart/form-data">
                                                @method('post')
                                                @csrf
                                                        ...
                                                        <div class="relative bg-white rounded-lg shadow black:bg-slate-700">
                                                            ...
                                                            <div class="p-6 space-y-4">
                                                                <div class="input-area relative">
                                                                    ...
                                                                    <label for="largeInput" class="form-label">Confirmar eliminar sesion</label>
                                    ...
                                    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" aria-hidden="true" role="dialog" tabindex="-1" id="modal-archivo">

                                        <form method="POST" action="{{ url('admin/archivo') }}" enctype="multipart/form-data">
                                            @method('POST')
                                            @csrf
