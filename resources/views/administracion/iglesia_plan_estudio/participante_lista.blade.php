                                                        ...
                                                        <div class="card-text h-full">
                                                            <div class="py-3 px-5">
                                                                <ul>
                                                                    ...
                                                                    <table
                                                                        class="divide-y divide-slate-100 table-fixed black:divide-slate-700"
                                                                        cellspacing="0" width="100%">
                                                                        <thead class="bg-slate-200 black:bg-slate-700">
                                                                            <tr
                                                                                class="even:bg-slate-50 black:even:bg-slate-700">
                                                                                <th
                                                                                    style="text-align: left;padding-top: 1%; padding-bottom:1%">
                                                                        ...
                                                                        <tbody
                                                                            class="bg-white divide-y divide-slate-100 black:bg-slate-800 black:divide-slate-700">
