                                    ...
                                    <form method="POST" action="{{ route('configuracion_correos.update',  $configcorreo->id) }}">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="password" id="smtp_password" name="smtp_password" value="{{  $configcorreo->smtp_password }}" class="form-control">
                                            </div>
                                            ...
                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">smtp_mailer</label>
                                                <input type="text" name="smtp_mailer" id="smtp_mailer" value="{{  $configcorreo->smtp_mailer}}" required class="form-control">
                                            </div>
