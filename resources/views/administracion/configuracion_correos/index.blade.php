            ...
            <div class="card">
                <div class="card-body flex flex-col p-6">
                    <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                        <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white"> Configuración de correos</div>
                    </header>
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="xl:col-span-12 col-span-12 lg:col-span-12">
                                        ...
                                        <form method="POST"
                                            ...
                                            @method('PUT')
                                            @csrf
                                            <input type="hidden" id="id" name="text"
                                                value="{{ $configcorreo->id }}" class="form-control">
                                        ...
                                        required class="form-control">
                                                ...
                                                <div class="input-area relative">
                                                    ...
                                                    <input type="text" name="smtp_from_name" id="smtp_from_name"
                                                        value="{{ $configcorreo->smtp_from_name }}" required
                                                        class="form-control">
                                                </div>
                                                ...
                                                <div class="input-area relative">
                                                    ...
                                                    <input type="text" name="smtp_encryption" id="smtp_encryption"
                                                        value="{{ $configcorreo->smtp_encryption }}" required
                                                        class="form-control">
                                                </div>
