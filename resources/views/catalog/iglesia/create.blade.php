                                    ...
                                    <form method="POST" action="{{ url('catalog/iglesia') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="name" id="name" required class="form-control" value="{{ old('name') }}" autofocus="true">
                                            </div>
                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Teléfono de Iglesia</label>
                                                <input type="text" name="phone_number" id="phone_number" required class="form-control" data-inputmask="'mask': ['9999-9999']" value="{{ old('phone_number') }}">
                                            </div>
                                            <div class="input-area relative">
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="address" id="address" required class="form-control" value="{{ old('address') }}">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Sede</label>
                                        ...
                                        <br>
                                        <h6>Datos Contactos</h6>
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Nombre de contacto</label>
                                                <input type="text" name="contac_name" id="contac_name" required class="form-control" value="{{ old('contac_name') }}">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Cargo de contacto</label>
                                                <input type="text" name="contact_job_title" id="contact_job_title" required class="form-control" value="{{ old('contact_job_title') }}">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Teléfono de contacto </label>
                                                <input type="text" name="contac_phone_number" id="contac_phone_number" required class="form-control" data-inputmask="'mask': ['9999-9999']" value="{{ old('contac_phone_number') }}">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Email de contacto</label>
                                                <input type="email" name="email_contact" id="email_contact" required class="form-control" value="{{ old('email_contact') }}">
                                            </div>
                                            <div class="input-area relative">
                                            ...
                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Nombre de Segundo Contacto</label>
                                                <input type="text" name="secondary_contac_name" id="secondary_contac_name" class="form-control" value="{{ old('secondary_contac_name') }}">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Cargo del segundo contacto</label>
                                                <input type="text" id="secondary_job_title" name="secondary_job_title" class="form-control" value="{{ old('secondary_job_title') }}">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Teléfono del Segundo contacto</label>
                                                <input type="text" name="secondary_contac_phone_number" id="secondary_contac_phone_number" class="form-control" data-inputmask="'mask': ['9999-9999']" value="{{ old('contac_phone_number') }}">
                                            </div>


                                        </div>
                                        <br>
                                        <h6>Datos de lider</h6>
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Nombre Lider Religioso</label>
                                                <input type="text" name="pastor_name" id="pastor_name" required class="form-control" value="{{ old('pastor_name') }}">
                                            </div>
                                            <div class="input-area relative">
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="personeria_juridica" id="personeria_juridica" required class="form-control" value="{{ old('Personeria_Juridica') }}">
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="facebook" id="facebook" required class="form-control" value="{{ old('facebook') }}">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Sitio Web</label>
                                                <input type="text" name="website" id="website" required class="form-control" value="{{ old('website') }}">
                                            </div>
