                                    ...
                                    <form method="POST" action="{{ url('catalog/iglesia') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="phone_number" id="phone_number" required class="form-control" value="{{ old('phone_number') }}">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">{{ __('Notas') }}</label>
                                                <input type="text" name="notes" id="notes" required class="form-control" value="{{ old('notes') }}">
                                            </div>
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="contac_phone_number" id="contac_phone_number" required class="form-control" value="{{ old('contac_phone_number') }}">
                                            </div>


                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">{{ __('Nombre de segundo Contacto') }}</label>
                                                <input type="text" name="secondary_contac_name" id="secondary_contac_name" required class="form-control" value="{{ old('secondary_contac_name') }}">
                                            </div>
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="secondary_contac_phone_number" id="secondary_contac_phone_number" required class="form-control" value="{{ old('contac_phone_number') }}">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">{{ __('telefono2 del Segundo  contacto') }}</label>
                                                <input type="text" name="secondary_contac_phone_number_2" id="secondary_contac_phone_number_2" required class="form-control" value="{{ old('contac_phone_number_2') }}">
                                            </div>
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="pastor_phone_number" id="pastor_phone_number" required class="form-control" value="{{ old('pastor_phone_number') }}">
                                            </div>
