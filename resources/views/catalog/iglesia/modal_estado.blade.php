<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" aria-hidden="true" role="dialog" tabindex="-1" id="modal-estado-{{$obj->id }}">

    <form id="basic-form" method="POST" action="{{ url('iglesia/modificar_estado')}}">
