                                                    ...
                                                    <div class="input-area relative">
                                                        ...
                                                        <div class="flex-none" id="div_img">
                                                            <div class="md:h-[186px] md:w-[186px] h-[140px] w-[140px] md:ml-0 md:mr-0 ml-auto mr-auto md:mb-0 mb-4 rounded-full ring-4                                                        ring-slate-100 relative">
                                                                ...
                                                                <button type="button" onclick="show_drop()" class="absolute right-2 h-8 w-8 bg-slate-50 text-slate-600 rounded-full shadow-sm flex flex-col items-center                                      justify-center md:top-[140px] top-[100px]">
                                                                    <iconify-icon icon="mdi:edit-circle" style="color: #1769aa;" width="40"></iconify-icon>
                                                                </button>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id="avatar" name="avatar" class="dropzone" style="display:none"> </div>
                            ...
                            <div class="grid grid-cols-12 gap-5">
                                ...
                                <div class="xl:col-span-12 col-span-12 lg:col-span-12">
                                    ...
                                    <div class="input-area relative">
                                        ...
                                        <button type="button" class="btn btn-black btn-sm float-right" data-bs-toggle="modal" data-bs-target="#modal-create-iglesia"> Agregar
                                            Pregunta
    ...
    <div class="2xl:col-span-12 lg:col-span-12 col-span-12">
        <div class="card">
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Grupos
