                                    ...
                                    <form method="POST" action="{{ route('member.update', $member->id) }}" class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" id="document_number" name="document_number" value="{{ $member->document_number }}" required class="form-control">
                                            </div>

                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label"> Telefono </label>
                                                <input type="text" name="cell_phone_number" value="{{ $member->cell_phone_number }}" id="cell_phone_number" required class="form-control" data-inputmask="'mask': ['9999-9999']" value="{{ old('cell_phone_number') }}">
                                            </div>
