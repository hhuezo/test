                    ...
                    <form method="POST" action="{{ url('catalog/member') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                            ...
                            <div class="input-area relative">
                                ...
                                <input type="text" name="last_name" onblur="this.value = this.value.toUpperCase()"
                                    required class="form-control" value="{{ old('last_name') }}" autofocus="true">
                            </div>
                            ...
                            <div class="input-area relative">
                                ...
                                <select name="catalog_gender_id" class="form-control" required>
                                    ...
                                    @foreach ($generos as $obj)
                                        <option value="{{ $obj->id }}" {{ old('catalog_gender_id') == $obj->id ? 'selected':'' }}>{{ $obj->description }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="input-area relative">
                                ...
                                <select name="grupo_id" id="grupo_id" class="form-control" required>
                                    ...
                                    @foreach ($grupos as $obj)
                                        <option value="{{ $obj->id }}" {{ old('grupo_id') == $obj->id ? 'selected':'' }}>{{ $obj->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="input-area relative">
                                ...
                                <select id="departamento_id" name="departamento_id" class="form-control" required>
                                    @foreach ($departamentos as $obj)
                                        <option value="{{ $obj->id }}" {{ old('departamento_id') == $obj->id ? 'selected':'' }}>
                                            {{ $obj->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="input-area relative">
                                ...
                                <select id="municipio_id" name="municipio_id" class="form-control" required>
                                    @foreach ($municipios as $obj)
                                        <option value="{{ $obj->id }}" {{ old('municipio_id') == $obj->id ? 'selected':'' }}>
                                            {{ $obj->nombre }}
                                        </option>
                                    @endforeach
                                </select>
