                                            ...
                                            <div class="flex-1">
                                                <div class="flex-none">
                                                    <div class="md:h-[186px] md:w-[186px] h-[140px] w-[140px] md:ml-0 md:mr-0 ml-auto mr-auto md:mb-0 mb-4 rounded-full ring-4  ring-slate-100 relative"
                                                        ...
                                                        <a href="{{ url('download/image') }}" title="Descargar Imagen"><img
                                                                src="{{ asset('img/qrcodeiglesia.png') }}" alt=""
                                                                class="w-full h-full object-cover rounded-full"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        <div class="card">
                                            <div class="card-body flex flex-col p-6">
                                                <header
                                                    ...
                                                    <div class="flex-1">
                                                        <a
                                                            href="{{ url('administracion/datos_iglesia') }}/{{ $iglesia->id }}">
